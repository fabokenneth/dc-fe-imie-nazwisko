<template>
  <div class="flex flex-col items-center">
    <div
      class="flex flex-col space-y-5 md:space-y-0 md:flex-row items-center w-full"
    >
      <div
        class="w-full md:w-32 px-4 md:px-0 md:mr-10 md:ml-20 flex items-center justify-between md:justify-start"
      >
      ...
      <div class="ml-5 w-28 hidden md:block">
        <language-picker v-if="isMedium" />
      </div>
    </div>
    ...
    <div class="mt-4 w-full">
      <div
        class="flex items-center pl-4 sm:pl-20 space-x-16 text-gray-500 mb-4"
      >
        <div
      ...
      <div class="w-full">
        ...
        >
          <thead class="bg-colliersGray-300">
            <tr class="h-14">
              <th class="w-1/12 pl-20 py-3 hidden sm:table-cell">
                {{ t("datagrid.photo_th") }}
              </th>
              ...
              <th class="w-1/12 pl-6 py-3 hidden sm:table-cell">
                {{ t("datagrid.gender_th") }}
              </th>
              <th class="w-1/12 pl-6 py-3 hidden md:table-cell">
                {{ t("datagrid.species_th") }}
              </th>
              <th class="w-1/12 pl-6 py-3">
          ...
          <tbody>
            ...
            >
              <td class="pl-20 hidden sm:table-cell">
              ...
              <td class="pl-6 py-3 hidden md:table-cell">
        ...
        <div
          ...
          class="flex items-center justify-center text-colliersGray-400 mb-8"
        >
          {{ t("datagrid.no_data_lbl") }}
        </div>
...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    setup: () => {
        ...
        messages: {
          ...
          fr: {
            datagrid: {
              ...
              no_data_lbl: "Pas de données disponible",
            },
            gender: {
              Male: "Mâle",
              Female: "Femelle",
          ...
          de: {
            datagrid: {
              ...
              no_data_lbl: "Keine Daten verfügbar",
            },
            gender: {
              Male: "Männlich",
              Female: "Weiblich",
      ...
      const isMedium = computed(() => state.windowWidth >= 768)
