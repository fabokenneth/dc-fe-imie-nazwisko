      ...
      <div class="">
        <table class="w-full text-left">
          ...
          <tr class="h-14">
            ...
            <th class="w-1/12 pl-6 py-3">{{ t("datagrid.characterId_th") }}</th>
            ...
            <th class="w-1/12 pl-6 py-3">{{ t("datagrid.lastEpisode_th") }}</th>
            <th class="w-1/12 pl-6 py-3">{{ t("datagrid.addToFavorites_th") }}</th>
          </tr>
          </thead>
          <tbody>
          <tr
